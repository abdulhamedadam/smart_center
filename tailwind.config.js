...
export default {
    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                // Add modern extended palette
                gray: colors.slate, // Use slate as default gray
                zinc: colors.zinc,
    ...
    safelist: [
        ...
        {
            pattern: /(fill|stroke)-(slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-(500|600|700)/,
        },
    ],
    plugins: [forms],
};
