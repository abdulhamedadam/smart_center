...
class CrmFollowUpsPolicy
{
     ...
     */
    public function view(User $user, CrmFollowUps $crmFollowUps): bool
    {
     ...
     */
    public function update(User $user, CrmFollowUps $crmFollowUps): bool
    {
     ...
     */
    public function delete(User $user, CrmFollowUps $crmFollowUps): bool
    {
     ...
     */
    public function forceDelete(User $user, CrmFollowUps $crmFollowUps): bool
    {
     ...
     */
    public function restore(User $user, CrmFollowUps $crmFollowUps): bool
    {
     ...
     */
    public function replicate(User $user, CrmFollowUps $crmFollowUps): bool
    {
