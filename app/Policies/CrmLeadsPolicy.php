...
class CrmLeadsPolicy
{
     ...
     */
    public function view(User $user, CrmLeads $crmLeads): bool
    {
     ...
     */
    public function update(User $user, CrmLeads $crmLeads): bool
    {
     ...
     */
    public function delete(User $user, CrmLeads $crmLeads): bool
    {
     ...
     */
    public function forceDelete(User $user, CrmLeads $crmLeads): bool
    {
     ...
     */
    public function restore(User $user, CrmLeads $crmLeads): bool
    {
     ...
     */
    public function replicate(User $user, CrmLeads $crmLeads): bool
    {
